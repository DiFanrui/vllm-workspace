        ...
        try:
            ...
            if isinstance(quant_cfg, dict):
                ...
                if quant_method == FP8_METHOD:
                    return FP8_METHOD
                if quant_method == AWQ_ASCEND_METHOD:
                    # Import triggers @register_quantization_config so the
                    # method is available for explicit --quantization too.
                    from vllm_ascend.quantization.awq_ascend_config import (
                        AscendAWQConfig,  # noqa: F401
                    )
